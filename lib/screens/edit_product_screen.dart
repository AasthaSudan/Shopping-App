...
import 'package:untitled6/providers/product.dart';
...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  void didChangeDependencies() {
    if (_isInit) {
      ...
      if (productId != null && productId.isNotEmpty) {
        ...
        // New product — leave _editedProduct with empty values
      }
    }
    _isInit = false;
  ...
  void _saveForm() {
    ...
    // If there is an ID, it means this is an update, not an add
